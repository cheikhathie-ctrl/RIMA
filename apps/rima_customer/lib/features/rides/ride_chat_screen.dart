...
class _RideChatScreenState extends State<RideChatScreen> {
    ...
    try {
      ...
      if (mounted) {
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(content: Text(RimaText.ui('Unable to send message.'))),
        );
      }
    } catch (e) {
  ...
  Widget _translationBanner() {
    return Container(
      ...
      child: Row(
        children: [
          const Icon(Icons.translate_rounded, color: RimaColors.primary, size: 20),
          SizedBox(width: 9),
          Expanded(
            child: Text(
              RimaText.ui('Messages are automatically translated to your preferred language when needed.'),
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              ElevatedButton(onPressed: _loadMessages, child: Text(RimaText.ui('Retry'))),
            ],
          ),
        ),
      );
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              SizedBox(height: 14),
              Text(RimaText.ui('No messages yet'), style: TextStyle(fontSize: 18, fontWeight: FontWeight.w800)),
              SizedBox(height: 6),
              Text(
                RimaText.ui('Send a message about pickup, landmarks, timing, or the ride.'),
        ...
        child: Column(
          ...
          children: [
            ...
            if (!isMine && translationStatus == 'failed') ...[
              ...
              Text(
                RimaText.ui('Translation unavailable — showing original message.'),
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              Row(
                children: [
                  const Icon(Icons.translate_rounded, color: RimaColors.primary),
                  SizedBox(width: 9),
                  Text(RimaText.ui('Original message'), style: const TextStyle(fontSize: 18, fontWeight: FontWeight.w800)),
                ],
              ),
          ...
          Expanded(
            child: TextField(
              ...
              decoration: InputDecoration(
                hintText: '${RimaText.ui('Message')} ${widget.otherPartyLabel}',
                filled: true,
  ...
  String _languageLabel(String? code) {
    switch ((code ?? '').toLowerCase()) {
      case 'ar': return RimaText.ui('Arabic');
      case 'fr': return RimaText.ui('French');
      case 'en': return RimaText.ui('English');
