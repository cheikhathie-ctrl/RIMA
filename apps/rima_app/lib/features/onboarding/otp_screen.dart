...
import '../driver/driver_available_rides_screen.dart';
...
class _OtpScreenState extends State<OtpScreen> {
  ...
  Future<void> _verifyOtp() async {
    ...
    try {
      ...
      final phone = currentUser?.phone ?? widget.phoneNumber;

      Widget nextScreen;

      // DEVELOPMENT ROUTING ONLY
      // Replace later with user_roles-based routing.
      if (phone == '+22236123457' || phone == '22236123457') {
        nextScreen = const DriverAvailableRidesScreen();
      } else {
